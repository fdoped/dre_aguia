...
.td-orc   { width: 18%; padding: 0 10px; text-align: right; border: none;
            white-space: nowrap; font-variant-numeric: tabular-nums;
            font-feature-settings: "tnum" 1; color: #3D5A78; font-size: 12px;
            font-weight: 400; letter-spacing: 0.01em; }
.td-var   { width: 10%; padding: 0 10px; text-align: right; border: none;
            white-space: nowrap; font-size: 11.5px; letter-spacing: 0.02em; }
.td-label { width: 40%; }
.td-pct   { width: 10%; }
...
.td-val-sm  { padding-top: 7px; padding-bottom: 7px; font-weight: 500; font-size: 12px;
              font-variant-numeric: tabular-nums; font-feature-settings: "tnum" 1; }
.td-val-xs  { padding-top: 5px; padding-bottom: 5px; font-weight: 400; font-size: 11.5px;
              font-variant-numeric: tabular-nums; font-feature-settings: "tnum" 1; }
...
.td-mes {
  ...
  font-variant-numeric: tabular-nums; font-feature-settings: "tnum" 1;
  color: #3D5A78; font-size: 11.5px; font-weight: 400; background: rgba(6,13,26,.3);
